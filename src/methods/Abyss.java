...
public class Abyss extends CraftMethod {
    ...
    public Abyss(final TreeScript handler, final RuneTypes runeType, final FoodTypes foodType) {
        ...
        TreeTask tenth = ninth.setLeft(new HasStaminaPotionInInventory());
        ...
        ninth = eighth.setLeft(new HasNecessaryItems(handler));
        ninth.setLeft(new OpenBank());
        ninth.setRight(new WalkToMage(handler));
        eighth.setRight(new TeleportToAbyss(handler));
        eighth = seventh.setRight(new IsNearMage());
        ...
        sixth = fifth.setLeft(new HasNecessaryItems(handler));
        seventh = sixth.setLeft(new HasEnoughEssence());
        eighth = seventh.setLeft(new IsGloryEquipped());
        ninth = eighth.setLeft(new IsGloryInInventory());
